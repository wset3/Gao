...
local Themes = {
	...
	AMOLED = {
	    ...
	    ElementTransparency = 0.98,
	    ToggleSlider = Color3.fromRGB(255, 255, 255), -- Black slider
	    ToggleToggled = Color3.fromRGB(0, 0, 0), -- Blue background when toggled ON
	    ToggleBorder = Color3.fromRGB(0, 0, 255), -- White border
